...
export default function () {
  return (
    ...
    >
      ...
      <p>
        At Star Wars Loretracker, accessible from
        https://star-wars-loretracker.vercel.app/, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by Star Wars Loretracker
        and how we use it.
      </p>
      ...
      <p>
        Star Wars Loretracker follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, Star Wars Loretracker uses 'cookies'. These
      ...
      <p>
        ...
        advertising partners of Star Wars Loretracker.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Star Wars Loretracker, which are
      ...
      <p>
        Note that Star Wars Loretracker has no access to or control over these
      ...
      <p>
        Star Wars Loretracker's Privacy Policy does not apply to other
      ...
      <p>
        Star Wars Loretracker does not knowingly collect any Personal
